...
namespace SSDL
{
    ...
    public class BOM
    {
        ...
        private Point3d Get_Max_Min_Point(string Layer_name, string Bom_Location)
        {
            ...
            dtpoint.Columns.Add("MinX");
            dtpoint.Columns.Add("MinY");
            dtpoint.Columns.Add("MaxX", typeof(double));// System.Type.GetType("System.Int32"));
            dtpoint.Columns.Add("MaxY");
            ...
            if (AutocadLayerwise)
            {
                ...
                foreach (DataRow datarow in layerlist.Rows)
                {
                    ...
                    try
                    {
                        ...
                        this.createautocadtablelayerwise(dtnewExcel, pt, layerval);
                    }
                    catch (System.Exception ex)
                    {
        ...
        public void createautocadtablelayerwise(System.Data.DataTable dt, Point3d insertionpoint, string layername)
        {
            if (dt.Rows.Count == 0)
            {
